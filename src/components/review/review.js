                ...
                >
                  <SwiperSlide>
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/dsoNgcsypfM"
                  ...
                  <SwiperSlide>
                    <iframe
                      ...
                      width="100%"
                      style={{ borderRadius: "10px" }}
                      src="https://www.youtube.com/embed/-qYz87nS6LU"
                      title="YouTube video player"
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowfullscreen
                  ...
                  <SwiperSlide>
                    <iframe
                      ...
                      width="100%"
                      style={{ borderRadius: "10px" }}
                      src="https://www.youtube.com/embed/q9HlIDuaL7Q"
                      title="YouTube video player"
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowfullscreen
                  ...
                  <SwiperSlide>
                    <iframe
                      ...
                      width="100%"
                      style={{ borderRadius: "10px" }}
                      src="https://www.youtube.com/embed/RoQgek0i6v0"
                      title="YouTube video player"
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowfullscreen
                  ...
                  <SwiperSlide>
                    <iframe
                      ...
                      width="100%"
                      style={{ borderRadius: "10px" }}
                      src="https://www.youtube.com/embed/0RIX5OX-ZC8"
                      title="YouTube video player"
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowfullscreen
                  ...
                  <SwiperSlide>
                    <iframe
                      ...
                      width="100%"
                      style={{ borderRadius: "10px" }}
                      src="https://www.youtube.com/embed/12GtCFd-PFM"
                      title="YouTube video player"
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowfullscreen
                  ...
                  <SwiperSlide>
                    <iframe
                      ...
                      width="100%"
                      style={{ borderRadius: "10px" }}
                      src="https://www.youtube.com/embed/IQXHlT_QtyI"
                      title="YouTube video player"
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowfullscreen
