            ...
            <div className={styles.footer_list}>
              <div className={styles.footer_btn}>
                <button onClick={() => setShow(!show)}>
                  Open Footer {show ? <FaAngleUp /> : <FaAngleDown />}
                </button>
              </div>
              ...
              {show ? (
                <div className={`${styles.footer_list_inner} ${styles.open}`}>
                  <p>
                    Alshifa Healthcare Services is successful medical tourism
                    company in India. They have history with Health Ministry,
                    Insurance Companies, Health Service Providers etc. They will
                    also help individuals find cheap medical treatment and
                    travelling options.
                  </p>
                  <ul>
                ...
                <div className={`${styles.footer_list_inner} ${styles.close}`}>
                  ...
                  <p>
                    ...
                    Health Service Providers, Self-funded Business persons and
                    Third Party Administrators besides individuals seeking
                    affordable Medical Treatment and Travel Options.
                  </p>
                  <ul>
                    {footerTxt.map((footer) => {
                      return (
